...
/// <inheritdoc />
API_STRUCT(Namespace="RmlUi") struct RMLUIMODULE_API RmlUiPropertySource
{
...
/// <inheritdoc />
API_CLASS(Namespace="RmlUi") class RMLUIMODULE_API RmlUiProperty : public ScriptingObject
{
