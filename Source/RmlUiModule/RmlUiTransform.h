...
/// <inheritdoc />
API_STRUCT(NoDefault, Namespace="RmlUi") struct RMLUIMODULE_API RmlUiTransformPrimitive
{
...
/// <inheritdoc />
API_CLASS(Namespace="RmlUi", NoSpawn) class RMLUIMODULE_API RmlUiTransform : public ScriptingObject
{
...
/// <inheritdoc />
API_CLASS(Namespace="RmlUi", NoSpawn) class RMLUIMODULE_API RmlUiTransforms : public ScriptingObject
{
