...
int FlaxFontEngineInterface::GetStringWidth(Rml::FontFaceHandle handle, const Rml::StringView str, const Rml::TextShapingContext& text_shaping_context, Rml::Character prior_character)
{
    auto normalStr = (Rml::String)str;
    const StringAnsiView text(normalStr.c_str(), (int32)normalStr.length());
    auto font = (Font*)handle;
...
int FlaxFontEngineInterface::GenerateString(Rml::RenderManager& render_manager, Rml::FontFaceHandle handle, Rml::FontEffectsHandle font_effects_handle, const Rml::StringView str,
